all: \
    ...
    $(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/vp9_idct_sse2.o \
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/vp9_idct_sse2.o \
    : \
    source/libvpx/vp9/common/x86/vp9_idct_sse2.asm \
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assembly source/libvpx/vp9/common/x86/vp9_idct_sse2.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -D CHROMIUM -I source/config/mac/ia32 -I source/config -I source/libvpx -I "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx" -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/vp9_idct_sse2.o" "source/libvpx/vp9/common/x86/vp9_idct_sse2.asm"
